...
export const useICS2 = () => {
  const { t } = useI18n()

  const ics2FormSchemas = [
    {
      type: 'input',
    ...
    },
    {
      ...
      field: 'customer_id',
      apiURL: '/api/v1/base/info?params=customer&service_type=ics2',
      multiple: false,
    },
    {
      type: 'multipleSelect',
      ...
      field: 'sender_name',
      apiURL: '/api/v1/base/info?params=sender&service_type=ics2',
    },
    {
      type: 'multipleSelect',
      label: t('common.warehouse'),
      field: 'warehouse',
      apiURL: '/api/v1/base/info?params=warehouse&service_type=ics2',
    },
    {
      type: 'multipleSelect',
      label: t('common.customBroker'),
      field: 'custom_broker',
      apiURL: '/api/v1/base/info?params=custom_broker&service_type=ics2',
    },
    {
      type: 'input',
